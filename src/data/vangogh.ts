...
export const paintings: Painting[] = [
  ...
  },
  {
    ...
    year: '1889',
    description: 'A masterpiece showing the crucified Christ in a rural French setting.',
    brushstrokeDetail: 'Vibrant yellow palette evoking spiritual depth.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Paul_Gauguin_1889_The_Yellow_Christ.jpg/500px-Paul_Gauguin_1889_The_Yellow_Christ.jpg',
    location: 'Albright-Knox Art Gallery, Buffalo',
    locationUrl: 'https://albrightknox.org/',
  },
  {
